...
function Register(props) {
  ...
  return (
    ...
    background: "radial-gradient(circle, rgba(238,174,202,1) 0%, rgba(148,187,233,1) 100%)",minHeight: "100vh",marginBottom:"10px"}}>
      <img alt="logo" src={logo} className="mx-auto d-block" style={{ width: "200px", marginBottom:"10px",  }} />
      <Form
        onSubmit={SubmitRec}
        style={{
          maxWidth: "450px",
